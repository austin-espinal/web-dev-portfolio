...
function About() {
    return (
        <div>
            ...
            <p className="bg">Welcome to my portfolio! My name is Austin Espinal and I am full-stack web developer. I have experience with HTML, CSS, Javascript, Node, MySQL, and NoSQL.<br />
